...
from ..util import (get_pku_pair_by_safety, model_contains_nan_params,
...
if __name__ == "__main__":
    ...
    # 2. load the dataset
    train_dataset = get_pku_pair_by_safety("train", sanity_check=script_args.sanity_check, cache_dir='data_cache/pku_safety_pair')
    eval_dataset = get_pku_pair_by_safety("test", sanity_check=script_args.sanity_check, cache_dir='data_cache/pku_safety_pair')
