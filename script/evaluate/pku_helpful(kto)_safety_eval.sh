...
models=(
    ...
    "$model_dir/helpful_kto_0.1"
    "$model_dir/helpful_kto_safety_dpo_0.1"
    "$model_dir/helpful_kto_safety_dpo_0.05"
    "$model_dir/helpful_kto_safety_dpo_0.025"
    "$model_dir/helpful_kto_safety_dpo_0.01"
)
...
case $mode in
    ...
    evaluate_full)
        ...
        ;;
    *)
        echo "Invalid mode: $mode. Please choose from 'generate', 'evaluate_base', 'evaluate'."
        exit 1
        ;;
esac
